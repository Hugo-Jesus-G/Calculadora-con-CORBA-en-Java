 ...
 implements calculadoraOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("divicion", new java.lang.Integer (3));
    _methods.put ("exponencial", new java.lang.Integer (4));
    _methods.put ("seno", new java.lang.Integer (5));
    _methods.put ("coseno", new java.lang.Integer (6));
    _methods.put ("tangente", new java.lang.Integer (7));
